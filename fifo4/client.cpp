#include "client.h"
#include "Util.h"
#define MAX_COMMUNICATE_TIMES 10
...
int main(int argc ,char **argv)
{
	...
	UTIL_DeleteFile(CLIENT_FIFO_NAME);
	cout <<"Delete "<< CLIENT_FIFO_NAME ;
...
// 		exit(EXIT_FAILURE);
// 	}
// 	printf(" starting 5: read client_fifo_name \n");
// 	for(int i=0; i<MAX_COMMUNICATE_TIMES; i++)
// 	{
// 		ResultInfo RI;
// 		res = read(client_fifo_fd, &RI, sizeof(ResultInfo));
// 		if (res > 0)
