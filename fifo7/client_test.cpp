...
int main(int argc ,char **argv)
{
	...
	if (argc>=3)
	{
		...
		strcpy(CI1.ID,argv[2]);
		strcpy ( CI1.Hash ,argv[3] );
	}
	else
	{
		strcpy( CI1.Hash, "120.85.133.215:6969@7cf7493eeceb3e6e426d04e69db1fa2c52373474");
		CI1.Grade = 1;	
		//strcpy( CI1.Hash, "192.168.2.160:6969@1a785446388d5046edb256b6b3d7b6518bda4533");
		//CI1.Grade = 2;	
		strcpy( CI1.ID, "6303B8");
	}
	
	strcpy( CI1.Path, "/tmp/hdd/volumes/HDD/12/unit3");
	//strcpy( CI1.ID, "9820120306094808.rmvb");
	CI1.Level = 12 ;
